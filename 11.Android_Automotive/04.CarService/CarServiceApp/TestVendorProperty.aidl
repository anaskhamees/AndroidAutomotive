...
enum TestVendorProperty {
    ...
    ITI = 0x0144 + 0x20000000 + 0x01000000 + 0x00400000,
    /**11**/

    gpio = 0x0145 + 0x20000000 + 0x01000000 + 0x00400000,
    /**21400145**/


    i2c = 0x0146 + 0x20000000 + 0x01000000 + 0x00400000,
    /**21400146**/

    prob = 0x0147 + 0x20000000 + 0x01000000 + 0x00400000,
   ...
   /****************************************************anas********************************************************/
    ...
    LED=0x200+ 0x20000000 + 0x01000000 + 0x00400000,
    
    TemperatureAnasValue=0x201+0x20000000 + 0x01000000 + 0x00400000
