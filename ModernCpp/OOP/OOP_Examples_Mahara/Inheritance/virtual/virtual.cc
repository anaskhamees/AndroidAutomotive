...
int main() {
    ...
    geometric *ptr=&t;
    std::cout << "Triangle Area: " << ptr->getArea() << std::endl;

    rectangle r(4.0f, 6.0f);
    ptr=&r;
    std::cout << "Rectangle Area: " << ptr->getArea() << std::endl;

    square s(5.0f);
    ptr=&s;
    std::cout << "Square Area: " << ptr->getArea() << std::endl; // This line will not compile due to private inheritance
